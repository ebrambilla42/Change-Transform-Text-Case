...
<items>
  <item arg="%(lower)s">
    ...
    <icon>img/lowercase.png</icon>
  </item>
  <item arg="%(upper)s">
    <title>%(upper)s</title>
    <subtitle>Transform text to `UPPERCASE`</subtitle>
    <icon>img/uppercase.png</icon>
  </item>
  <item arg="%(title)s">
    <title>%(title)s</title>
    <subtitle>Transform text to `Title Case`</subtitle>
    <icon>img/titlecase.png</icon>
  </item>
  <item arg="%(camel)s">
    <title>%(camel)s</title>
    <subtitle>Transform text to `CamelCase`</subtitle>
    <icon>img/camelcase.png</icon>
  </item>
  <item arg="%(kebab)s">
    <title>%(kebab)s</title>
    <subtitle>Transform text to hyphenated `kebab-case`</subtitle>
    <icon>img/kebabcase.png</icon>
  </item>
  <item arg="%(snake)s">
    <title>%(snake)s</title>
    <subtitle>Transform text to `snake_case`</subtitle>
    <icon>img/snakecase.png</icon>
  </item>
  <item arg="%(parentesis)s">
    <title>%(parentesis)s</title>
    <subtitle>Transform text to (text)</subtitle>
    <icon>img/parentesis.png</icon>
  </item>
  <item arg="%(escaped)s">
    <title>%(escaped)s</title>
    <subtitle>Transform text to 'text'</subtitle>
    <icon>img/escape.png</icon>
  </item>
</items>""" % variations
